...
namespace AgileLabs.Dapper.FluentMap.Resolver
{
    ...
    /// </summary>
    public class AgilePropertyResolver : AgileMapper.PropertyResolverBase
    {
        /// <inheritdoc/>
        ...
        public override IEnumerable<PropertyInfo> ResolveProperties(Type type)
        {
            ...
            {
                foreach (var property in AgileMapper.Resolvers.Default.PropertyResolver.ResolveProperties(type))
                {
                    yield return property;
                }
            }
